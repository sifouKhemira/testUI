        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Flexible(
                //the padding is used to achieve the waveform of the ui u provided
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Padding(
                    ...
                    Padding(
                      ...
                      child: AudioWave(
                        ...
                        bars: [
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.7, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.9, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xffFFFFFF)),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: AudioWave(
                        ...
                        spacing: 5,
                        bars: [
                          AudioWaveBar(heightFactor: 1, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.5, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 1, color: const Color(0xffFFFFFF)),
                        ],
                    ...
                    Padding(
                      ...
                      child: AudioWave(
                        ...
                        bars: [
                          AudioWaveBar(heightFactor: 1, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xffFFFFFF)),
                          AudioWaveBar(heightFactor: 0.5, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 1, color: const Color(0xff7F7F7D)),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: AudioWave(
                        ...
                        spacing: 5,
                        bars: [
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 0.6, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 1, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 0.8, color: const Color(0xff7F7F7D)),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: AudioWave(
                        ...
                        bars: [
                          ...
                          AudioWaveBar(heightFactor: 0.6, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 0.5, color: const Color(0xff7F7F7D)),
                          AudioWaveBar(heightFactor: 0.2, color: const Color(0xff7F7F7D)),
                        ],
                      ),
                    ),
                  ],
